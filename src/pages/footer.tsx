        ...
        if (href) {
          return (
            <a
              ...
              } py-1.5 px-2.5 flex items-center justify-center rounded-xl font-normal`}
              href={`#${href}`}
              key={index}
            >
              {text}
        ...
        return (
          ...
          >
            ...
            <div
              ...
              className={`${
                childrenClassName || ""
              }  py-1 focus:opacity-100 focus-within:opacity-100 opacity-0 focus:h-auto focus-within:h-auto h-0 absolute bottom-11 rounded-md shadow-lg outline-none bg-white`}
            >
              {children?.map(({ text, href }, index) => {
                ...
                return (
                  <a
                    ...
                    } py-2 px-4 flex items-center rounded-xl font-normal whitespace-nowrap`}
                    href={`#${href}`}
                    key={index}
                  >
                    {text}
